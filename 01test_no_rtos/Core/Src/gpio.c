...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, EPD_RES_Pin|EPD_DC_Pin|EPD_CS_Pin|EN_CHK_VU_Pin
                          |BT_BRTS_Pin|AHT_SCL_Pin|T_SCL_Pin|T_SDA_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = KEY_OK_Pin|KEY_R_Pin|KEY_L_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PBPin PBPin */
  GPIO_InitStruct.Pin = BT_CDS_Pin|BT_BRTS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PBPin PBPin */
  GPIO_InitStruct.Pin = BT_LINK_Pin|AHT_SDA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
